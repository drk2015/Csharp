...
namespace Module8
{
    ...
    class Course
    {
       ...
       // private ArrayList studentArr = new ArrayList();
        private List<Student> studentArr=new List<Student>();

        public List<Student> StudentArr
        {
        ...
        /*private List<Teacher> teacherArr = new List<Teacher>();

        public List<Teacher> TeacherArr
        {
